...
public class FileUtil {
    ...
    private String[] videoType =
            {".mp4", ".avi", ".3gp", ".rmvb", "wav", "mpg", "vob", "mov", "flv", "swf"};
    ...
    public JsonResult saveFile(HttpServletRequest request, MultipartFile file, String saveUrl) {
        ...
        if (!file.isEmpty()) {
            ...
            String fileName =
                    UUID.randomUUID().toString().replace("-", "") + originalName.lastIndexOf(".")
                            + fileType;  //新文件名的文件
            ...
            String relativePath =
                    saveUrl + File.separator + dateDir + File.separator + fileName;  //相对路径地址
     ...
     * @throws Exception
     */
    public void download(HttpServletResponse response, HttpServletRequest request, String path, String contentType, String realName) throws Exception {
