...
<!-- css -->
<link href="${pageContext.request.contextPath}/assets/front/css/bootstrap.min.css" rel="stylesheet" />
<link href="${pageContext.request.contextPath}/assets/front/css/fancybox/jquery.fancybox.css" rel="stylesheet">
<link href="${pageContext.request.contextPath}/assets/front/css/flexslider.css" rel="stylesheet" />
<link href="${pageContext.request.contextPath}/assets/front/css/style.css" rel="stylesheet" />
        ...
        <div class="navbar navbar-default navbar-static-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.jsp"><img src="${pageContext.request.contextPath}/assets/front/img/logo.png" alt="logo"/></a>
                </div>
								     ...
								     <div class="testimonials">
										<div class="active item">
										  ...
										  <div class="carousel-info">
											<img alt="" src="${pageContext.request.contextPath}/assets/front/img/team4.jpg" class="pull-left">
											<div class="pull-left">
...
<script src="${pageContext.request.contextPath}/assets/front/js/jquery.js"></script>
<script src="${pageContext.request.contextPath}/assets/front/js/jquery.easing.1.3.js"></script>
<script src="${pageContext.request.contextPath}/assets/front/js/bootstrap.min.js"></script>
<script src="${pageContext.request.contextPath}/assets/front/js/jquery.fancybox.pack.js"></script>
<script src="${pageContext.request.contextPath}/assets/front/js/jquery.fancybox-media.js"></script>
<script src="${pageContext.request.contextPath}/assets/front/js/jquery.flexslider.js"></script>
<script src="${pageContext.request.contextPath}/assets/front/js/animate.js"></script>
<!-- Vendor Scripts -->
<script src="${pageContext.request.contextPath}/assets/front/js/modernizr.custom.js"></script>
<script src="${pageContext.request.contextPath}/assets/front/js/jquery.isotope.min.js"></script>
