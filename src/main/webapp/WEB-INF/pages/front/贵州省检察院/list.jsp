...
<div id="section">
    ...
    <div class="nav">
        <ul>
            <li class=""><a href="${pageContext.request.contextPath}/${column.webId}/index">首页</a></li>
        ...
        <div class="listNav">
            <div class="breadNav rt of">
                <ul class="of">
                    ...
                    <li><a href="${pageContext.request.contextPath}/${column.webId}/index">首页 ></a></li>
                    <li><a href="">${column.coluName} </a></li>
                </ul>
            </div>
            <p class='listTit'><span class="shenglue">${column.coluName}</span></p>
        ...
        <div class="list of">
            ...
            <div class="RTcont lf">
                <ul class="" id="art_list">
                    ...
                    <%--<li><span>2017-10-19</span><a href="details.html">贵州省人民检察院依法对余越前等4人决定逮捕</a></li>
                    <li><span>2017-10-19</span><a href="">贵州省人民检察院依法对余越前等4人决定逮捕</a></li>
                    <li><span>2017-10-19</span><a href="">贵州省人民检察院依法对余越前等4人决定逮捕</a></li>
                    <li><span>2017-10-19</span><a href="">贵州省人民检察院依法对余越前等4人决定逮捕</a></li>
                    <li><span>2017-10-19</span><a href="">贵州省人民检察院依法对余越前等4人决定逮捕</a></li>
                    <li><span>2017-10-19</span><a href="">贵州省人民检察院依法对余越前等4人决定逮捕</a></li>
...
<script type="text/javascript">
    ...
    function putData(pageNum,coluId) {
        $.getJSON('${pageContext.request.contextPath}/${column.webId}/data/${column.id}', {
