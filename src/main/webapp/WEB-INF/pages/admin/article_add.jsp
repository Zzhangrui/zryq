...
<form class="layui-form" action="" style="padding: 20px;">
    <input type="hidden" name="coluName" value="${coluName}">
    <input type="hidden" name="coluId" value="${coluId}">
    <div class="layui-form-item">
        <label class="layui-form-label">标题</label>
        <div class="layui-input-block">
            <input type="text" name="artTitle" lay-verify="title" autocomplete="off" placeholder="请输入标题" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item layui-form-text">
        <label class="layui-form-label">摘要</label>
        <div class="layui-input-block">
            <textarea placeholder="请输入摘要" id="digest" name="artDigest" class="layui-textarea"></textarea>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="tel" name="artFrom"  autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-inline">
            <label class="layui-form-label">作者</label>
            <div class="layui-input-inline">
                <input type="text" name="artAuthor"  autocomplete="off" class="layui-input">
            </div>
        </div>
    </div>
    ...
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block">
            <textarea placeholder="请输入内容" style="height: 340px;" name="artContent" id="editor_id" class="layui-textarea"></textarea>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="radio" name="openCommen" value="1" title="放开" checked="">
            <input type="radio" name="openCommen" value="2" title="禁止">
            <input type="radio" name="openCommen" value="3" title="审查">
            <input type="radio" name="openCommen" value="4" title="过滤">
        </div>
    </div>
