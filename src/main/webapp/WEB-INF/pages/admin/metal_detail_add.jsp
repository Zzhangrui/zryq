...
<form class="layui-form layui-form-pane" style="padding: 5px;margin-left: 110px;" >
    <input type="hidden" name="id" value="${metalDetail.id}"/>

    <div class="layui-form-item">
        <div class="layui-inline">
        <label class="layui-form-label">名称</label>
        <div class="layui-input-inline">
            <input type="text" name="metalName" lay-verify="required" value="${metalDetail.metalName}"   autocomplete="off" class="layui-input">
        </div>
        </div>
        <div class="layui-inline">
            <label class="layui-form-label">型号</label>
            <div class="layui-input-inline">
                <input type="text" name="metalModel" lay-verify="scrollDesc" value="${metalDetail.metalModel}"   autocomplete="off" class="layui-input">
            </div>
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <select name="cateId" lay-verify="" lay-search>
                    <c:forEach items="${metalCateList}" var="cate">>
                        <option value="${cate.id}" <c:if test="${metalDetail.cateId eq cate.id}">selected </c:if>>${cate.cateName}</option>
                    </c:forEach>
                </select>
            </div>
        </div>
        ...
        <div class="layui-input-inline">
            <input type="text" name="metalPrice" lay-verify="scrollDesc" value="${metalDetail.metalPrice}"   autocomplete="off" class="layui-input">
        </div>
            <div class="layui-form-mid layui-word-aux">/每吨</div>
        </div>
    </div>
    <div class="layui-form-item">
...
<script>
    layui.use(['form','layer','upload'], function(){
        ...
        var url="${pageContext.request.contextPath}/metalDetail/${url}";
        //监听保存提交
