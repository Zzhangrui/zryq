                    ...
                    <div id="con_box_con">
                        ...
                        <div id="section_name">
                            ...
                            <div class="public_wrap">
                                ...
                                <article>
                                    <div class="btn_box">
                                        <button id="art-add" class="layui-btn layui-btn-normal layui-btn-small"><i class="layui-icon"></i>新增站点</button>
...
<script>
    ...
    function putData(pageNum) {
        $.getJSON('${pageContext.request.contextPath}/web/data', {
            title: $("#title").val(),
            ...
            table.render({
                ...
                , cols: [[
                    {checkbox: true}
                    ,{field: 'id', title: '站点ID', width: 100, sort: false}
                    ,{field: 'webName', title: '站点名称', width: 200, sort: false}
                    , {field: 'webDes', title: '站点描述', width: 200, sort: false}
                    , {field: 'webAddress', title: '站点域名', width: 200, sort: true}
                    , {field: 'webCode', title: '站点编码', width: 200, sort: true}
    ...
    function  updateState(msg,id,state){
        layer.confirm(msg, function (index) {
            $.ajax({
                url:"${pageContext.request.contextPath}/update/"+id+"/"+state,
                type:"post",
                dataType:"json",
