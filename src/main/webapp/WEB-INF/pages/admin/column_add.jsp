...
<div>
    <form class="layui-form" action="" style="padding: 20px;">
        ...
        <input type="hidden" name="coluImgPath" id="coluImgPath">
        <input type="hidden" name="coluImgName" id="coluImgName">
        <div class="layui-form-item">
            <label class="layui-form-label">栏目名称</label>
            <div class="layui-input-block">
                <input type="text" name="coluName" lay-verify="title" autocomplete="off" placeholder="请输入站点名称" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-upload">
                ...
                <img id="colu-logo" width="254" height="80" style="margin-left: 10px;">
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                <textarea placeholder="请输入描述信息" id="digest" name="coluDes" class="layui-textarea"></textarea>
            </div>
        </div>
        ...
        var uploadInst = upload.render({
            ...
            ,done: function(res){
                ...
                if(res.code > 0){
                    ...
                    //todo 域名地址
                    $("#coluImgPath").val(res.url);
                    $("#coluImgName").val(res.fileName);
            ...
            ,error: function(){return layer.msg('上传失败');
            }
        });
