    ...
    <form class="layui-form" action="" style="padding: 20px;">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="webName" lay-verify="title" value="${webInfo.webName}" autocomplete="off" placeholder="请输入站点名称" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="webAddress"  value="${webInfo.webAddress}" autocomplete="off" placeholder="请输入域名" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="webCode" value="${webInfo.webCode}"  autocomplete="off" placeholder="请输入编码" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                <textarea placeholder="请输入摘要" id="digest" name="webDes" class="layui-textarea">${webInfo.webDes}</textarea>
            </div>
        </div>
...
<script>
    layui.use(['form', 'layedit', 'laydate', 'layer', 'jquery', 'upload'], function () {
        ...
        $.ajax({
            ...
            success:function(res){
                if(res.success){
                    ...
                    var webId = "${webInfo.parentId}";

                    $("#webId").find("option[value='"+webId+"']").attr("selected",true);
                    form.render('select');
                }else{
        ...
        var tempId = "${webInfo.tempId}";

        $("#webTemp option[value='"+tempId+"']").attr("selected",true);
