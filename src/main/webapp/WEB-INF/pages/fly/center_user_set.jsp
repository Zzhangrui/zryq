                    ...
                    <form method="post" class="layui-form">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" id="L_email" name="email" required lay-verify="email" autocomplete="off" value="${selfUser.email}" class="layui-input" disabled>
                            </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" id="L_username" name="nickName" required lay-verify="required" autocomplete="off" value="${selfUser.nickName}" class="layui-input">
                            </div>
                            <div class="layui-inline">
                                <div class="layui-input-inline">
                                    <input type="radio" name="sex" value="0"  <c:if test="${selfUser.sex eq '0'}">checked=""</c:if> title="男">
                                    <input type="radio" name="sex" value="1" <c:if test="${selfUser.sex eq '1'}">checked=""</c:if> title="女">
                                </div>
                            </div>
                        </div>
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" id="L_city" name="address" autocomplete="off" value="${selfUser.address}" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item layui-form-text">
                            <label for="L_sign" class="layui-form-label">签名</label>
                            <div class="layui-input-block">
                                <textarea placeholder="随便写些什么刷下存在感" id="L_sign"  name="sign" autocomplete="off" class="layui-textarea" style="height: 80px;">${selfUser.sign}</textarea>
                            </div>
                        </div>
                        <div class="layui-form-item">
                ...
                <div class="layui-form layui-form-pane layui-tab-item">
                    <div class="layui-form-item">
                        <div class="avatar-add">
                            ...
                            <button type="button" class="layui-btn upload-img" id="upload-img-btn">
                                <i class="layui-icon">&#xe67c;</i>上传头像
                            </button>
                            <img src="${pageContext.request.contextPath}/${selfUser.imgPath}" id="user-img">
                            <p id="demoText"></p>
                ...
                <div class=" layui-form-pane layui-tab-item">
                    <form action="" method="post" class="layui-form">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="password" id="L_nowpass" name="localPassword" required lay-verify="required" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
